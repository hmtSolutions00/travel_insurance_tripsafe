        ...
        <div class="card-body">
          ...
          <form class="forms-sample" action="{{ route('website.configuration.update', $config->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label for="site_name"><strong>Nama Website</strong></label>
            ...
            <div class="form-group">
              <label for="logo"><strong>Logo Website</strong></label>
              <input type="file" name="logo" class="form-control @error('logo') is-invalid @enderror" id="logo">
              @if ($config->logo)
                <div class="mt-2">
                  <img src="{{ asset( $config->logo) }}" style="width: 200px; height: 200px; object-fit: contain; border-radius: 10px; border: 1px solid #ccc; padding: 5px;">
                </div>
              @endif
              @error('logo')
                <span class="text-danger">{{ $message }}</span>
            ...
            <div class="form-group">
              <label for="about_us"><strong>Tentang Kami</strong></label>
            ...
            <div class="form-group">
              <label for="url_photo_background"><strong>Background Website</strong></label>
              ...
              @if ($config->url_photo_background)
                <div class="mt-2">
                  <img src="{{ asset( $config->url_photo_background) }}" style="width: 100%; max-width: 500px; height: auto; object-fit: cover; border-radius: 10px; border: 1px solid #ccc; padding: 5px;">
                </div>
              @endif
            ...
            <div class="form-group">
              <label for="title"><strong>Judul Website</strong></label>
            ...
            <div class="form-group">
              <label for="keywords"><strong>Kata Kunci</strong></label>

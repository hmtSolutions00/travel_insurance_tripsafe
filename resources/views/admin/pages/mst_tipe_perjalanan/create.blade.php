...
<div class="content-wrapper">
  <div class="page-header">
    <h3 class="page-title"> Tambah Master Data Tipe Perjalanan </h3>
    <ol class="breadcrumb">
  ...
  <div class="row">
    <div class="col-md-6 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Form Tambah Data Tipe Perjalanan</h4>
          ...
          {{-- Form Tambah Data --}}
          <form class="forms-sample" action="{{ route('admin.master.tipe_perjalanan.store') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
              ...
              <textarea class="form-control @error('description') is-invalid @enderror" 
                        ...
                        placeholder="Deskripsi Tipe Perjalanan">{{ old('description') }}</textarea>

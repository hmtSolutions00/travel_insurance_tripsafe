                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-4 mb-3">
                                        ...
                                        <select name="package_id" id="package_id" class="form-control form-control-lg">
                                            <option value="{{ $asuransi->package_id }}" selected disabled>{{ $asuransi->nama_paket }}</option>
                                    ...
                                    <div class="col-12 col-lg-4 mb-3">
                                        ...
                                        <select name="tipe_asuransi" id="tipe_asuransi"
                                            ...
                                            <option value="{{ $asuransi->insuranceType_id }}" selected disabled>{{ $asuransi->tipe_asuransi }}</option>
                                    ...
                                    <div class="col-12 col-lg-4 mb-3">
                                        ...
                                        <select name="wilayah" id="wilayah" class="form-control form-control-lg">
                                            <option value="{{ $asuransi->destination_id }}" selected disabled>{{ $asuransi->wilayah }}</option>
                                    ...
                                    <div class="col-12 col-lg-4 mb-3">
                                        ...
                                        <select name="tipe_perjalanan" id="tipe_perjalanan"
                                            class="form-control form-control-lg">
                                            <option value="{{ $asuransi->tipePerjalanan_id }}" selected disabled>{{ $asuransi->tipe_perjalanan }}</option>
                                    ...
                                    <div class="col-12 col-lg-4 mb-3">
                                        ...
                                        <input type="number" name="cetak_polis" id="cetak_polis"
                                            placeholder="Contoh: 10000" class="form-control form-control-lg" min="0" value="{{ $asuransi->cetak_polis }}">
                                    </div>
                                    <div class="col-12 col-lg-4 mb-3">
                                        <label for="name" class="mb-2">Harga Tambahan per Minggu (IDR)</label>
                                        <input type="number" name="extra_price" id="extra_price"
                                            placeholder="Contoh: 50000" class="form-control form-control-lg" min="0" value="{{ $asuransi->extra_price }}">
                                    </div>
                                    <div class="col-12 col-lg-4 mb-5">
                                        <label for="name" class="mb-2">Premi (IDR)</label>
                                        <input type="number" name="premi" id="premi" placeholder="Contoh: 50000"
                                            class="form-control form-control-lg" min="0" value="{{ $asuransi->price }}">
                                    </div>
                                    <div class="col-12 col-lg-4 mb-5">

...
<div class="content-wrapper">
  <div class="page-header">
    <h3 class="page-title"> Edit Master Data Paket Asuransi </h3>
    <ol class="breadcrumb">
  ...
  <div class="row">
    <div class="col-md-6 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Form Ubah Data Paket Asuransi</h4>
          ...
          {{-- Form Tambah Data --}}
          <form class="forms-sample" action="{{ route('admin.paket_asuransi.update',$paketAsuransi->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('name') is-invalid @enderror" 
                     ...
                     value="{{ $paketAsuransi->nama_paket }}" 

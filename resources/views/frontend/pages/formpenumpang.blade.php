            ...
            <form action="/tambah/pesanan/asuransi" method="post" id="form-pesanan-asuransi" enctype="multipart/form-data">
                ...
                <div class="row  mt-0">
                    <div class="col-12 col-lg-4 mb-2 text-center position-relative">
                        <div class="row m-1">
                            <div class="col-12 col-lg-12 text-center bg-white position-relative mb-3"
                                ...
                                <div class="m-4">
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-lg-6 mb-1" style="text-align: right">
                                            <small><input type="text" readonly
                                                    value="{{ $paket_asuransi['tipe_perjalanan'] }}" class="input-asuransi"
                                                    id="tipe_perjalanan" name="tipe_perjalanan"></small>
                                        ...
                                        <div class="col-6 col-lg-6 mb-1" style="text-align: right">
                                            <small><input type="text" readonly
                                                    value="{{ $paket_asuransi['product_name'] }}" class="input-asuransi"
                                                    id="product_name" name="product_name"></small>
                                        </div>
                                        ...
                                        <div class="col-6 col-lg-6 mb-1" style="text-align: right">
                                            <small><input type="text" readonly
                                                    value="{{ $paket_asuransi['nama_paket'] }}" class="input-asuransi"
                                                    id="paket_asuransi" name="paket_asuransi"></small>
                                        </div>
                                        ...
                                        <div class="col-6 col-lg-6 mb-1" style="text-align: right">
                                            <small><input type="text" readonly
                                                    value="{{ $paket_asuransi['tipe_asuransi'] }}" class="input-asuransi"
                                                    id="tipe_asuransi" name="tipe_asuransi"></small>
                                        </div>
                                        <div class="col-6 col-lg-6 mb-1" style="text-align: left">
                                            <small class="fw-bold">Wilayah Tujuan</small>
                                        </div>
                                        <div class="col-6 col-lg-6 mb-1" style="text-align: right">
                                            <small><input type="text" readonly value="{{ $paket_asuransi['wilayah'] }}"
                                                    class="input-asuransi" id="wilayah" name="wilayah"></small>
                                        </div>
                                        @php
                                        ...
                                        <div class="col-6 col-lg-6 mb-1" style="text-align: right">
                                            <small><input type="text" readonly value="{{ $tglBerangkat }}"
                                                    class="input-asuransi" id="tanggal_keberangkatan"
                                                    name="tanggal_keberangkatan"></small>
                                        </div>
                                        ...
                                        <div class="col-6 col-lg-6 mb-3" style="text-align: right">
                                            <small><input type="text" readonly value="{{ $tglPulang }}"
                                                    class="input-asuransi" id="tanggal_kepulangan"
                                                    name="tanggal_kepulangan"></small>
                                        </div>
                                        ...
                                        <div class="col-6 col-lg-6 mb-1" style="text-align: right">
                                            <small><input type="text" readonly value="{{ $paket_asuransi[0]['anak'] }}"
                                                    class="input-asuransi" id="anak" name="anak"
                                                    style="width: 50px;">
                                                orang</small>
                                        </div>
                                        <div class="col-6 col-lg-6 mb-1" style="text-align: left">
                                        ...
                                        <div class="col-6 col-lg-6 mb-1" style="text-align: right">
                                            <small><input type="text" readonly
                                                    value="{{ $paket_asuransi[0]['dewasa'] }}" class="input-asuransi"
                                                    id="dewasa" name="dewasa" style="width: 50px;">
                                                orang</small>
                                        </div>
                                        ...
                                        <div class="col-6 col-lg-6 mb-3" style="text-align: right">
                                            <small>
                                                <input type="text" readonly value="{{ $paket_asuransi[0]['lansia'] }}"
                                                    class="input-asuransi" id="lansia" name="lansia"
                                                    style="width: 50px;">
                                                orang
                                            </small>
                                        </div>
                                        ...
                                        <div class="col-6 col-lg-6 mb-1" style="text-align: right">
                                            <small><input type="text" readonly value="{{ $premi }}"
                                                    class="input-asuransi" id="premi" name="premi"></small>
                                        </div>
                                        ...
                                        <div class="col-6 col-lg-6 mb-2"
                                            style="text-align: right; align-content: center;">
                                            <small><input type="text" readonly value="{{ $cetakPolis }}"
                                                    class="input-asuransi" id="cetak_polis" name="cetak_polis"></small>
                                        </div>
                                        <div class="col-6 col-lg-6 mb-1" style="text-align: left">
                                            <small class="fw-bold">Total Harga (IDR)</small>
                                        </div>
                                        <div class="col-6 col-lg-6 mb-1" style="text-align: right">
                                            <small><input type="text" readonly value="{{ $total }}"
                                                    class="input-asuransi" id="total_premi" name="total_premi"></small>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-12 text-center bg-white position-relative mb-3"
                                ...
                                <div class="m-4">
                                    ...
                                    @endphp
                                    <ul class="nav nav-tabs d-flex justify-content-center border-0 cust-tab"
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-penumpang active fw-bold" id="tab-penumpang-1"
                                                ...
                                                role="tab" aria-controls="penumpang-1-tab"
                                                aria-selected="true">Pelanggan
                                                1</button>
                                        </li>
                                        @for ($i = 2; $i <= $jlhPelanggan; $i++)
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-penumpang fw-bold"
                                                    id="tab-penumpang-{{ $i }}" data-bs-toggle="tab"
                                                    data-bs-target="#penumpang-{{ $i }}-tab" type="button"
                                                    role="tab" aria-controls="penumpang-{{ $i }}-tab"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-lg-6 mb-3" style="text-align: left">
                                                    ...
                                                    <input type="text" name="namal_1" id="namal_1"
                                                        class="form-control form-control-sm" value="{{ old('namal_1') }}" required>
                                                </div>
                                                ...
                                                <div class="col-12 col-lg-3 mb-3" style="text-align: left">
                                                    ...
                                                    <input type="text" name="email_1" id="email_1"
                                                        class="form-control form-control-sm" value="{{ old('email_1') }}" required>
                                                </div>

                                                <div class="col-12 col-lg-3 mb-3" style="text-align: left">
                                                    <small class="form-check-label mb-5 fw-bold"
                                                        for="tempat_lahir_1">Tempat
                                                        Lahir</small>
                                                    <input type="text" name="tempat_lahir_1" id="tempat_lahir_1"
                                                        class="form-control form-control-sm" required value="{{ old('tempat_lahir_1') }}">
                                                </div>
                                                ...
                                                <div class="col-12 col-lg-3 mb-3" style="text-align: left">
                                                    ...
                                                    <input type="date" name="tanggal_lahir_1" id="tanggal_lahir_1"
                                                        class="form-control form-control-sm" required value="{{ old('tanggal_lahir_1') }}">
                                                </div>
                                                ...
                                                <div class="col-12 col-lg-3 mb-3" style="text-align: left">
                                                    ...
                                                    <input type="text" name="no_passport_1" id="no_passport_1"
                                                        class="form-control form-control-sm" required value="{{ old('no_passport_1') }}">
                                                </div>
                                                ...
                                                <div class="col-12 col-lg-3 mb-3" style="text-align: left">
                                                    ...
                                                    <input type="text" name="no_telepon_1" id="no_telepon_1"
                                                        class="form-control form-control-sm" required value="{{ old('no_telepon_1') }}">
                                                </div>
                                                ...
                                                <div class="col-12 col-lg-3 mb-3" style="text-align: left">
                                                    ...
                                                    <input type="text" name="pekerjaan_1" id="pekerjaan_1"
                                                        class="form-control form-control-sm" required value="{{ old('pekerjaan_1') }}">
                                                </div>
                                                ...
                                                <div class="col-12 col-lg-3 mb-3" style="text-align: left">
                                                    ...
                                                    <input type="text" name="kode_pos_1" id="kode_pos_1"
                                                        class="form-control form-control-sm" required value="{{ old('kode_pos_1') }}">
                                                </div>

                                                <div class="col-12 col-lg-3 mb-3" style="text-align: left">
                                                    <small class="form-check-label mb-5 fw-bold"
                                                        for="provinsi_1">Provinsi</small>
                                                    <input type="text" name="provinsi_1" id="provinsi_1"
                                                        class="form-control form-control-sm" required value="{{ old('provinsi_1') }}">
                                                </div>
                                                ...
                                                <div class="col-12 col-lg-3 mb-3" style="text-align: left">
                                                    ...
                                                    <input type="text" name="kota_1" id="kota_1"
                                                        class="form-control form-control-sm" required value="{{ old('kota_1') }}">
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-lg-6 mb-3" style="text-align: left">
                                                        ...
                                                        <input type="text" name="namal_{{ $i }}"
                                                            id="namal_{{ $i }}"
                                                            class="form-control form-control-sm" required value="{{ old('namal_'.$i) }}">
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-lg-3 mb-3" style="text-align: left">
                                                        ...
                                                        <input type="text" name="tempat_lahir_{{ $i }}"
                                                            id="tempat_lahir_{{ $i }}"
                                                            class="form-control form-control-sm" required value="{{ old('tempat_lahir_'. $i) }}">
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-lg-3 mb-3" style="text-align: left">
                                                        ...
                                                        <input type="date" name="tanggal_lahir_{{ $i }}"
                                                            id="tanggal_lahir_{{ $i }}"
                                                            class="form-control form-control-sm" required value="{{ old('tanggal_lahir_'.$i) }}">
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-lg-3 mb-3" style="text-align: left">
                                                        ...
                                                        <input type="text" name="no_passport_{{ $i }}"
                                                            id="no_passport_{{ $i }}s"
                                                            class="form-control form-control-sm" required value="{{ old('no_passport_'.$i) }}">
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-lg-3 mb-3" style="text-align: left">
                                                        ...
                                                        <input type="text" name="no_telepon_{{ $i }}"
                                                            id="no_telepon_{{ $i }}"
                                                            class="form-control form-control-sm" required value="{{ old('no_telepon_'.$i) }}">
                                                    </div>
                            ...
                            <div class="col-12 col-lg-12 text-center bg-white position-relative"
                                style="border-radius: 12px">
                                <div class="m-4">
                                    <div class="row">
                                        <div class="col-8 col-lg-12 text-center position-relative mb-2">
                                            <small style="font-style: italic"><i
                                                    class="fa-solid fa-triangle-exclamation text-warning"></i> Pastikan

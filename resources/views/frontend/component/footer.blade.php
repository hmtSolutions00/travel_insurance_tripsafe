    ...
    <div class="container mt-0 mb-0">
        <div class="row">
            <div class="col-12 col-sm-6 col-lg-3 mb-5 mb-lg-0">
                <h5 class="mb-3 fs-6">Our Social Media</h5>
            ...
            <div class="col-12 col-sm-6 col-lg-3 mb-5 mb-lg-0">
                ...
                <div class="d-flex justify-content-lg-center">
                    <ul class="fl-menu">
                        ...
                        <li class="nav-item"><a href="{{route('frontend.pages.halamanfile')}}" class="text-dark">Brosur</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-lg-6 mb-5 mb-lg-0">
                ...
                <div class="flex-grow-1">
                    <span class="text-sm theme-text-dark"> Selamat Datang di <span class="fw-bold">{{$websiteConfig->site_name}}</span><br>
